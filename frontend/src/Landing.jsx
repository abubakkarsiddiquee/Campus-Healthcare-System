    ...
    <div className="font-sans text-gray-900 bg-pink-100">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {features.map((f, idx) => (
          <div 
            key={idx} 
            className="p-6 bg-pink-100 rounded-lg shadow-md hover:shadow-lg transition"
          >
            ...
            <div className="font-semibold text-lg mb-2">
              {f.title === "Discussion Forum" ? (
                <a href="/forum" className="hover:underline text-pink-700">
                  {f.title}
                </a>
              ) : (
                f.title
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12">
            ...
            <div className="space-y-8">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-pink-700">Email Support</h4>
                  <p className="text-pink-600">support@campushealth.edu</p>
                  <p className="text-sm text-pink-500">Response within 24 hours</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-pink-700">Phone Support</h4>
                  <p className="text-pink-600">(555) 123-HEALTH</p>
                  <p className="text-sm text-pink-500">Mon-Fri, 8 AM - 6 PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  <h4 className="font-semibold text-pink-700">Campus Health Center</h4>
                  <p className="text-pink-600">123 University Drive, Campus Town, CT 12345</p>
                  <p className="text-sm text-pink-500">Building hours: 7 AM - 11 PM</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-pink-600">Crisis Line: (555) 987-6543</p>
                  <p className="text-pink-600">Campus Security: (555) 555-0911</p>
                  <p className="text-sm text-pink-500">Available 24/7</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white rounded-lg p-8 shadow-md">
              <h3 className="text-2xl font-bold text-pink-700 mb-2">Send us a Message</h3>
              <p className="text-pink-600 mb-6">We'll respond within 24 hours.</p>
              ...
              <form className="space-y-4">
                ...
                <select className="w-full px-4 py-3 border border-pink-300 rounded-lg focus:ring-2 focus:ring-pink-400 focus:border-transparent">
                ...
                <div className="flex items-start space-x-3">
                  <input type="checkbox" className="mt-1 w-4 h-4 text-pink-600 border-pink-300 rounded focus:ring-pink-400" />
                  <label className="text-sm text-pink-600">
                ...
                <button
                  type="submit"
                  className="w-full bg-pink-600 text-white py-3 px-6 rounded-lg font-semibold hover:bg-pink-500 transition"
                >
                  Send Message
                </button>
              </form>
